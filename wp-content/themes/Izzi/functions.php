...
function custom_login_logo() {
    echo '<style type ="text/css">.login h1 a { background-image:url('.get_stylesheet_directory_uri().'/images/logo-izzi.png);height:70px;width:300px;background-size:auto;background-position:center bottom; }</style>';
}
